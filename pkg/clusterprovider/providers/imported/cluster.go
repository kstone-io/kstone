...
func (c *EtcdClusterImported) BeforeCreate(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) Create(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) AfterCreate(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) BeforeUpdate(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) Update(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) AfterUpdate(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) BeforeDelete(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) Delete(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) AfterDelete(cluster *kstoneapiv1.EtcdCluster) error {
	return nil
}

func (c *EtcdClusterImported) Equal(cluster *kstoneapiv1.EtcdCluster) (bool, error) {
	return true, nil
}

// Status gets the imported etcd cluster status
func (c *EtcdClusterImported) Status(tlsConfig *transport.TLSInfo, cluster *kstoneapiv1.EtcdCluster) (kstoneapiv1.EtcdClusterStatus, error) {
